<p align="center">
  <a href="https://david-dm.org/alexdevero/electron-text-to-speech-reader"><img alt="Dependency Status" src="https://david-dm.org/alexdevero/electron-text-to-speech-reader.svg?style=flat"></a>
  <a href="https://david-dm.org/alexdevero/electron-text-to-speech-reader?type=dev"><img alt="devDependency Status" src="https://david-dm.org/alexdevero/electron-text-to-speech-reader/dev-status.svg?style=flat"></a>
  <a href="http://opensource.org/licenses/MIT"><img alt="MIT License" src="https://img.shields.io/npm/l/express.svg"></a>
  <!-- <a href="https://github.com/alexdevero/electron-text-to-speech-reader/releases"><img alt="Current release" src="https://img.shields.io/github/release/alexdevero/electron-text-to-speech-reader.svg"></a> -->
</p>
...
```bash
git clone https://github.com/alexdevero/electron-text-to-speech-reader.git
```
